 ...
 * @author PC
 */
public class DeudasdelMesController implements Initializable {
    ...
    private void reporteardo(String inicio , String fin) {
        try {
            ...
            InputStream inputStream = getClass().getResourceAsStream("/reportes/RPT_adeudo_proveedores/Adeudo_Provedores.jrxml");
