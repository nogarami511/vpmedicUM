 ...
 * @author alfar
 */
public class EgresoseIngresosHosptilaController implements Initializable {
    ...
    private void reporteardo(String inicio, String fin) {
        try {
            ...
            InputStream inputStream = getClass().getResourceAsStream("/reportes/reporteestadodecuentaegreso/reporteestadodecuenta.jrxml");
