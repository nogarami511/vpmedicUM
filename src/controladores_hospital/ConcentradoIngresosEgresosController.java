 ...
 * @author PC
 */
public class ConcentradoIngresosEgresosController implements Initializable {
    ...
    private void reporteardo(String inicio , String fin) {
        try {
            ...
            InputStream inputStream = getClass().getResourceAsStream("/reportes/concentradodelmes/ConcentradoIngresoEgreso.jrxml");
