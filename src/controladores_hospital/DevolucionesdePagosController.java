 ...
 * @author PC
 */
public class DevolucionesdePagosController implements Initializable {
    @FXML
    ...
    @FXML
    private Button btnGenerarDevolucion;
    @FXML
    ...
    @FXML
    private void accionGenerarDelucon(ActionEvent event) {
    ...
    @FXML
    private void acciondevolucion(ActionEvent event) throws SQLException {
        ...
        if (respuesta == "es un dato no valido"){
            ...
            id_devolucion = pagosDAO.GenerarDevolucion(pagogeneral.getId_pago(), monto, VPMedicaPlaza.userSystem);
