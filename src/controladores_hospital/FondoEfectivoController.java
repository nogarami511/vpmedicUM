 ...
 * @author Gerardo
 */
public class FondoEfectivoController implements Initializable {
    ...
    ObservableList<FondoEfectivo> fondosEfectivos = FXCollections.observableArrayList();
    ...
    @FXML
    private TableView<FondoEfectivo> tabla;
    @FXML
    ...
    public void llenarTabla() throws SQLException {
        try {
            ...
            List<FondoEfectivo> fondoE = fondoEfectivoDAO.obtenerTodosLosFondosEfectivoDeEsteMes();

            // Crear una lista observable para los datos de la tabla
            fondosEfectivos.addAll(fondoE);
    ...
    private void seleccionMes(ActionEvent event) throws SQLException {
        ...
        FondoEfectivoDAO fondoEfectivoDAO = new FondoEfectivoDAO(con);
        List<FondoEfectivo> f = fondoEfectivoDAO.obtenerTodosLosFondosEfectivoXMes(mes.getNumeroMes());
    ...
    private void quitarDeFondoEfectivo(ActionEvent event) {
        FondoEfectivo fondoEfectivo = tabla.getSelectionModel().getSelectedItem();
    ...
    @FXML
    private void actualizarfondoefectivofijo(KeyEvent event) {
    ...
    private void Aceptarcontra(ActionEvent event) throws SQLException {
        ...
        if (txtcontraseña.getText().equals("Caja321")) {
            try {
                ...
                montoingresado = fondoefectivofijoDAO.leerFondoEfectivoFijoPorId(1).getMonto();
                System.err.println("Error: Ingrese un número válido.");

            }
            fondoefectivofijoDAO.actualizarFondoEfectivoFijo(1, montoingresado);
        }
